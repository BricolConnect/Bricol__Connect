        ...
        <div className="container-fluid p-0" id='heroSection'>
            ...
            <div className="row g-0">
                ...
                <div className="card w-100 shadow" id='card'>
                    ...
                    <h2 className="text-center fw-bold mb-4" style={{fontSize: '2.5rem'}}>Sign up artisan</h2>
                    ...
                    <form id>
                        ...
                        <button type="submit" className="btn btn-warning w-100 text-white shadow-sm mb-3" id='orangeBtn'>
                        S'inscrire
                        </button>
