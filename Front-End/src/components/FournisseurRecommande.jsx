    ...
    return (
        <div className="container py-5">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h5 className="fw-bold">Fournisseur Plus Recommandés</h5>
                <Link to='/' className="text-decoration-none fw-bold" style={{ color: '#EA580C' }}>Voir tout &rarr;</Link>
            </div>
            <div className="row">
                {dat_a.map((art) => (
                    <div className="col-md-4 mb-4 custom-card" key={art.id}>
...
export default FournisseurRecommande;